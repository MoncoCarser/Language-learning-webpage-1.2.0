...
def reverse_swe():
    ...
    words = translate_to_swedish_from_end(index)
...
"""    if right_wrong != "Correct":
        correct_answer = f"Correct answer was {correct_word} and you answered {user_answer}"
    else:
        correct_answer = """
   ...
   # print(correct_answer)
    ...
    return render_template("es_words.html", 
                            ...
                            index_follow_up = words[2], 
                            correct_or_wrong = right_wrong,
                            right_answer_guidance = correct_answer
                          )
