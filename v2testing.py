import os, time, wordlistsEngSlo
...
def asking_for_slovak_words():
    for i in range(len(english_words_list)):
        ...
        if answer_to_question_SK == slovak_words_list[i]:
            ...
            list_of_mistakes.append(english_words_list[i], slovak_words_list[i])
            time.sleep(1)
            os.system("clear")
